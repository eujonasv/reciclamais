  ...
  return (
    <section id="mapa-cta" className="section-padding bg-white dark:bg-gray-900">
      <div className="container mx-auto">
        <div className="relative rounded-2xl overflow-hidden p-8 md:p-16 bg-gradient-to-br from-recicla-primary to-recicla-accent dark:from-recicla-secondary dark:to-recicla-primary shadow-2xl">
          {/* Decorative elements */}
          <div className="absolute top-0 left-0 -translate-x-1/4 -translate-y-1/4 w-64 h-64 bg-white/10 dark:bg-white/5 rounded-full filter blur-2xl"></div>
          <div className="absolute bottom-0 right-0 translate-x-1/4 translate-y-1/4 w-72 h-72 bg-white/10 dark:bg-white/5 rounded-full filter blur-3xl"></div>
