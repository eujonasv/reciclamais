...
const CollectionPointCard = ({
  ...
  return <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 border border-gray-200 dark:border-gray-700 mb-4">
      ...
      <div className="flex flex-wrap gap-2 mt-4">
        <a href={`https://www.google.com/maps/search/?api=1&query=${point.latitude},${point.longitude}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-xs bg-white-100 text-gray-800 rounded-full hover:bg-white transition-colors mx-0 py-[5px] px-[2px]">
