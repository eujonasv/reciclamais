...
const AboutSection = () => {
  return (
    <section id="sobre" className="section-padding bg-gradient-to-b from-white via-green-50/70 to-recicla-primary/10 dark:from-gray-900 dark:via-green-900/20 dark:to-gray-900 relative z-10">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {features.map((feature) => (
            <div key={feature.id} className="flex flex-col items-center bg-white/85 dark:bg-gray-900/70 rounded-2xl shadow-lg transition hover:scale-105 hover:shadow-xl p-6 border border-green-100 dark:border-green-950/40">
        ...
        <div className="md:flex md:items-center md:justify-between bg-recicla-primary/10 dark:bg-green-900/30 py-8 px-6 rounded-xl shadow border border-green-200 dark:border-green-900/50">
          <div>
